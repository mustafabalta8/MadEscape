...
public class FenceCreation : MonoBehaviour
{
    [BoxGroup("Paths")]
    ...
    private static FenceCreation instance;
    public static FenceCreation Instance => instance ?? (instance = instance = FindObjectOfType<FenceCreation>());
    private void Awake()
    {
